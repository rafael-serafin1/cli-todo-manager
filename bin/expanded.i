...
# 1 "<command-line>"
# 1 "main.c"
# 1 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\c++\\stdlib.h" 1 3
# 36 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\c++\\stdlib.h" 3
...
# 42 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\c++\\cstdlib" 2 3
...
# 37 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\c++\\stdlib.h" 2 3

using std::abort;
using std::atexit;
using std::exit;
# 51 "c:\\mingw\\lib\\gcc\\mingw32\\6.3.0\\include\\c++\\stdlib.h" 3
using std::div_t;
using std::ldiv_t;
...
Status _todo_config();
Status _todo_add(const char* todo);
Status _todo_remove(const int index);
Status _todo_check(const char* todo);
Status _todo_uncheck(const char* todo);
